...
<center>
    ...
    <div class="container">
        <div class = "row">
            <div class="col-md-6">
                <iframe src="http://13.125.213.221:5601/app/kibana#/visualize/create?type=pie&indexPattern=d344bf50-3a89-11ea-97ee-6fe13df95fbf&_g=()&_a=(filters:!(),linked:!f,query:(language:lucene,query:''),uiState:(),vis:(aggs:!((enabled:!t,id:'1',params:(),schema:metric,type:count),(enabled:!t,id:'2',params:(field:recruitment_form.keyword,missingBucket:!t,missingBucketLabel:Missing,order:desc,orderBy:'1',otherBucket:!f,otherBucketLabel:Other,size:10),schema:segment,type:terms)),params:(addLegend:!t,addTooltip:!t,isDonut:!f,labels:(last_level:!t,show:!t,truncate:50,values:!t),legendPosition:top,type:pie),title:'New%20Visualization',type:pie))" style="width:100%; height:500px"></iframe>
            </div>
            <div class="col-md-6">
                <iframe src="http://13.125.213.221:5601/app/kibana#/visualize/create?type=pie&indexPattern=d344bf50-3a89-11ea-97ee-6fe13df95fbf&_g=()&_a=(filters:!(),linked:!f,query:(language:lucene,query:''),uiState:(),vis:(aggs:!((enabled:!t,id:'1',params:(),schema:metric,type:count),(enabled:!t,id:'2',params:(field:work_location.keyword,missingBucket:!f,missingBucketLabel:Missing,order:desc,orderBy:'1',otherBucket:!f,otherBucketLabel:Other,size:250),schema:segment,type:terms)),params:(addLegend:!t,addTooltip:!t,isDonut:!f,labels:(last_level:!t,show:!t,truncate:100,values:!t),legendPosition:right,type:pie),title:'New%20Visualization',type:pie))" style="width:100%; height:500px"></iframe>
            </div>
            </div>
        </div>
    </div>
